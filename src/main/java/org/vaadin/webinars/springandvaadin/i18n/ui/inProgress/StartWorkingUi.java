...
@Scope("prototype")
public class StartWorkingUi extends UI {
    ...
    protected void init(VaadinRequest request) {
        ...
        ChangeStatusClickListener listener = new ChangeStatusClickListener(name, id, description, expectedTime, status, "/task_manager/onTesting", getUI());
